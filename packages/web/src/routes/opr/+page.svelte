...
<WidthProvider width={"1000px"}>
    <Card>
        ...
        <div class="rest">
            <p>
                At the top of every team page on FTC<i>Stats</i> is a "Quick Stats" panel showing a
            ...
            <p>
                Most often on FTC<i>Stats</i>, penalties are not calculated in OPR, which is why you
